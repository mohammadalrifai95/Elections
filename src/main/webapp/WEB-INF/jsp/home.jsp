...
<div  class="fixedElement"  style="border: 3px solid #73AD21; background-color: #679FAB; width: 1300px; height: 100px; color: white;" >  
...
<div  class="fixedElement"  style=" background-color: white;  width: 1300px; height: 100px; margin-top: 100px;" >
...
<!-- 					<li><a href="#">List of voters 2020-2024 &#9660</a> -->
<!-- 						<ul class="submenu"> -->
...
<div  id="englishDiv" style=" background-color: #FFFFF9; padding-top: 1px; margin-top: 100px;">        
		...
		<table style="  color: #00008B;" >     
			<tr>
				<td class="imageContainer" id=""> 
					<a href="#"> 
						<p style="margin-left: 80px; font-size: 70px; color: green;">
						<img src="<c:url value="/resources/images/rules.png" />" alt="image"  style="width:1200px; height: 290px; "/> 
						</p>
					</a>	
				</td>
			</tr>
		...
		<table style="  color: #00008B;" >     
			<tr>
				<td class="imageContainer" id=""> 
					<a href="#"> 
						<p style="margin-left: 80px; font-size: 70px; color: green;">
						<img src="<c:url value="/resources/images/fourMembersNames.png" />" alt="image"  style="width:1200px; height: 353px; "/> 
						</p>
					</a>	
				</td>
			</tr>
		...
		<table style="  color: #00008B;" >     
			<tr>
				<td class="imageContainer" id=""> 
					<a href="#"> 
						<p style="margin-left: 80px; font-size: 70px; color: green;">
						<img src="<c:url value="/resources/images/modrinization.png" />" alt="image"  style="width:1200px; height: 353px; "/> 
						</p>
					</a>	
				</td>
			</tr>
